...
class YoloPreProcecess():
    ...
    def load_model(self):
        ...
        if self.webcam:
            ...
            self.dataset = LoadStreams(source, img_size=imgsz, stride=stride, auto=pt, vid_stride=self.vid_stride)
            ...
            self.dataset = LoadImages(source, img_size=imgsz, stride=stride, auto=pt, vid_stride=self.vid_stride)
...
class Yolo5Ros2(Node):
    ...
    def image_callback(self, image:Image):
        ...
        # return (class_list, confidence_list, x_min_list, y_min_list, x_max_list, y_max_list)
        class_list, confidence_list, x_min_list, y_min_list, x_max_list, y_max_list = self.yolov5.image_callback_pp(image_raw)
